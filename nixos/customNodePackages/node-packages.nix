...
in
{
  "@aws-amplify/cli" = nodeEnv.buildNodePackage {
    ...
    version = "12.0.0";
    src = fetchurl {
      url = "https://registry.npmjs.org/@aws-amplify/cli/-/cli-12.0.0.tgz";
      sha512 = "ffsxIeild+iNlKuqeKiMM3QCtLHAUGm6SBxuI35eljnkFhIFjNatMBUBtAuHR2OZnCnxj2GoWlq3P7Ajp0e/fQ==";
    };
    dependencies = [
